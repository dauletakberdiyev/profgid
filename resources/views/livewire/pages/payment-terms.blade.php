    ...
    <div class="space-y-8 text-gray-700 leading-relaxed">
        ...
        <div>
            ...
            <div class="space-y-4">
                ...
                <ul class="list-disc pl-6 space-y-1">
                    ...
                    <li>Ввести необходимые данные для совершения платежа</li>
        ...
        <div>
            ...
            <div class="space-y-4">
                ...
                <p>
                    <strong>5.2.</strong> Возврат НЕ осуществляется в следующих случаях:
                </p>
                <ul class="list-disc pl-6 space-y-2">
                    <li>После прохождения теста и получения результатов</li>
                    <li>После получения персональных рекомендаций</li>
                    <li>После проведения консультации специалиста</li>
                    <li>При нарушении Пользователем условий использования Сервиса</li>
                    <li>По причине изменения мнения Пользователя о необходимости услуги</li>
                </ul>
            </div>
        </div>
        ...
        <!-- Порядок возврата -->
        <div>
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">6. Порядок возврата денежных средств</h2>
            <div class="space-y-4">
                <p>
                    <strong>6.1.</strong> Для возврата денежных средств Пользователь должен:
                </p>
                <ul class="list-disc pl-6 space-y-1">
                    <li>Обратиться в службу поддержки по электронной почте</li>
                    <li>Указать причину возврата</li>
                    <li>Предоставить данные транзакции (номер платежа, дату, сумму)</li>
                    <li>Приложить скриншоты или другие подтверждающие документы при необходимости</li>
                </ul>
                <p>
        ...
        <div>
            ...
            <div class="space-y-4">
                ...
                ИП “Омарова” <br />
                БИН: 740902401498 <br />
                ИИК: KZ93722C000025493284 <br />
                г. Туркестан <br />
                БИК: CASPKZKA <br />
                Туркестанская обл. г. Кентау ул. КВАРТАЛ 67 Квартал д. 27
                </p>
            </div>
        </div>
